        ...
        <div className='container mt-3' >
            ...
            <div className="about-container" data-aos="zoom-in" data-aos-duration="1500">
                ...
                <div className="image-container" data-aos="zoom-in-up">
                    <img src="https://tse4.mm.bing.net/th?id=OIP.HqDHjZNlX4rLnKLURt7KgQAAAA&pid=Api&P=0&h=180"  data-aos="zoom-out-down" data-aos-duration="1500" alt="Psycho Image" className="img-fluid psycho-image" />
                </div>
            ...
            <div className="qualifications-container row">
                ...
                <div className="qualification-box col-10 col-lg-3 col-md-3" data-aos="flip-left" data-aos-duration="1500">
                    <h2 className="course-title">Master of Science</h2>
                    <p className="college-name">ABC University</p>
                </div>
                <div className="qualification-box col-10 col-lg-3 col-md-3" data-aos="fade-up-left" data-aos-duration="1500">
